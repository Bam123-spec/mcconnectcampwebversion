    ...
    <div className="min-h-screen bg-[#f7f7f5]">
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <nav className="mb-6 flex flex-wrap items-center gap-2 text-sm font-medium text-gray-500">
          <Link href="/" className="rounded-md transition-colors hover:text-[#51237f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#51237f] focus-visible:ring-offset-2">
            Home
          </Link>
          <span>/</span>
          <Link href="/events" className="rounded-md transition-colors hover:text-[#51237f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#51237f] focus-visible:ring-offset-2">
            Events
          </Link>
          <span>/</span>
        ...
        <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <aside className="space-y-6 bg-[#fbfbfa] p-6 sm:p-8">
              ...
              <section className="rounded-xl border border-[#51237f]/10 bg-[#51237f] p-6 text-white">
                <div className="text-[11px] font-bold uppercase tracking-[0.24em] text-purple-200">Status</div>
                <h3 className="mt-2 text-xl font-black tracking-tight">
                  {event.isRegistered ? "You are RSVP'd" : event.hasSession ? "Ready to RSVP" : "Sign in to RSVP"}
                </h3>
                <p className="mt-3 text-sm leading-6 text-purple-100/90">
                  {event.isRegistered
                    ? "This event is saved to your activity page. Cancel if your plans change."
                    : event.hasSession
                      ? "Reserve your spot and add this event to your activity page."
                      : "Log in with your campus account to reserve a spot and track it in activity."}
                </p>
                <div className="mt-5 rounded-lg bg-white p-3 text-gray-950">
                  <EventRsvpAction
                    eventId={event.id}
              ...
              <section className="rounded-xl border border-gray-200 bg-white p-6">
                ...
                <div className="mt-5 space-y-3">
                  <Link
                    href="/events"
                    className="inline-flex w-full items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-700 transition-colors hover:border-[#51237f]/20 hover:text-[#51237f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#51237f] focus-visible:ring-offset-2"
                  >
                    Back to events
                    <ArrowLeft size={16} />
                  </Link>
                  ...
                  <Link
                    href="/"
                    className="inline-flex w-full items-center justify-between rounded-lg border border-[#51237f]/10 bg-[#51237f] px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#43206a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#51237f] focus-visible:ring-offset-2"
                  >
                    Return home
                    <ArrowLeft size={16} />
                  </Link>
