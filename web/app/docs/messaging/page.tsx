    ...
    <>
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <p className="text-xl text-gray-600 mb-10 leading-relaxed font-medium">
          Campus Cord integrates direct messaging and organization-wide forums for seamless campus communication.
        </p>
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          All messaging instances on Campus Cord fall under the standard Montgomery College Title IX and Student Code of Conduct guidelines.
        </p>
